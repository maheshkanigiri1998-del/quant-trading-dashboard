    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-6 shadow-2xl flex flex-col justify-between">
            <div>
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-bold font-mono tracking-wide text-sm transition-all shadow-lg ${
                  loadingSwarm
              ...
              {/* TERMINAL OUTPUT ACCORDION BOX */}
              <div className="mt-6 bg-slate-950 border border-slate-800 rounded-lg p-4 font-mono text-xs min-h-[220px]">
            ...
            <div className="mt-6 p-3 bg-slate-950/60 border border-slate-800/80 rounded-lg flex items-center justify-between text-[11px] font-mono text-slate-400">
              <span>⚠️ Layer-2 Risk Filter</span>
